...
<body>
	<div class="container">
		...
		<div class="content">
			<form action="order/updata_order2/${o.id}" method="post">
				<div class="table dl_border" myAttr="goods" style="display: block;">
					...
					<dl>
						<dt>物流公司：</dt>
						<dd>
							<input type="text" name="logistics" class="text" value="${o.logistics}" />
						</dd>
					</dl>
					<dl>
						<dt>运单号：</dt>
						<dd>
							<input type="text" name="waybill" class="text" value="${o.waybill}" />
						</dd>
					</dl>
					<dl>
						<dt>收货人：</dt>
