...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/stock_in.css" />
<script
		...
		<form action="" method="post">
			<div class="content">
				<dl>
					<dt>商品选择:</dt>
					<dd>
						<input type="text" name="search_text" id="search_btn" class="text"
							value="" />
					</dd>
				</dl>
				...
				<dl>
					...
					<dd>
						<input type="submit" class="button" value="确 定"> <input
							type="button" id="aaa" class="button" value="返 回">
					</dd>
				</dl>
			</div>
		</form>
